...
const DropsCard = ({ image, name, description, userName }) => {
  return (
    <div className="hover:border hover:border-[#FCB808] cursor-pointer transition-all duration-300 ease-in-out rounded-[20px] w-full h-[550px]  md:w-[470px] md:h-[600px] flex justify-center items-center relative">
      {/* <div className=" w-[430px] h-[560px] flex flex-col justify-end relative"> */}
      <div className="md:w-[420px] md:h-[565px] w-[378px] h-[504px]">
      ...
      <div className="absolute bg-[linear-gradient(0deg,#161616_69.35%,rgba(22,22,22,0)_134.95%)] w-full md:w-[420px] bottom-4 rounded-[20px] p-5">
